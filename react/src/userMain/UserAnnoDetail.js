...
// import './User.css'
function UserAnnoDetail({ checkPermission }) {
                        ...
                        <div className="col-12">
                            <div className="card">
                                <div className="card-body" style={{ padding: '50px 70px 0 100px', height: '100%' }} >
                                    <div className='row'>
                                        <Link to="/user/annoList" className="inq-back" style={{ width: "50%" }}>
                                            ← 공지 목록
                                        </Link>
                                    ...
                                    {DetailData.notice_comment == 'O' ?
                                      <Comment style={{backgroundColor:"rgb(117, 116, 234)"}} pk={DetailData.notice_num} id={checkPermission.sub}/>
                                        : null}
