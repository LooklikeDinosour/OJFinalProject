...
function EnglProjectDetail(props) {
  ...
  useEffect(() => {
    axios.get(`http://13.209.147.231:8888/api/main/engleader/projectDetail/${pro_id}`)
      .then(response => {
    ...
    axios.post('http://13.209.147.231:8888/api/main/alarm/assignEmer', { engid: engid, serverId: serverId })
